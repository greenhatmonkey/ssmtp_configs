...
# print finished msg
# CLean up - delete email in tmp/email.smtp
...
#----------------------------------
# clean up sent email in /tmp
function clean_email()
{
# check if email still exists
toclean="/tmp/email.smtp"

# "-f" will check if a regular file exists (not directory or device) will return true if exists.
# "-e" will check if a file (can be directory or device) exists. will return true if exists.
